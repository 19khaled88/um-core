...
const getAllCourse =catchAsnc(async(req:Request,res:Response)=>{
    try {
        ...
        const errorMessage =
          error instanceof ApiError ? error.message : "Course or course not found for given ID";
        sendResponse(res,{
            statusCode:httpStatus.OK,
            success:false,
            message:errorMessage,
...
const singleCourse = catchAsnc(async (req: Request, res: Response) => {
  try {
    ...
    const errorMessage =
      error instanceof ApiError ? error.message : "Course not found for given ID";
    sendResponse(res,{
        statusCode:httpStatus.OK,
        success:false,
        message:errorMessage,
...
const deleteCourse = catchAsnc(async (req: Request, res: Response) => {
    try {
      ...
      const errorMessage =
        error instanceof ApiError ? error.message : "Course not deleted for given ID";
      sendResponse(res,{
          statusCode:httpStatus.OK,
          success:false,
          message:errorMessage,
  ...
  const updateCourse = catchAsnc(async (req: Request, res: Response) => {
    try {
      ...
      const errorMessage =
        error instanceof ApiError ? error.message : "Course not updated for given ID";
      sendResponse(res,{
          statusCode:httpStatus.OK,
          success:false,
          message:errorMessage,
